...
import 'message.chat.dart' as _i6;
import 'typing.chat.dart' as _i7;
import 'usermessage.chat.dart' as _i8;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i7.TypingIndicator) {
      return _i7.TypingIndicator.fromJson(data) as T;
    }
    if (t == _i8.UserMessage) {
      return _i8.UserMessage.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i7.TypingIndicator?>()) {
      return (data != null ? _i7.TypingIndicator.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i8.UserMessage?>()) {
      return (data != null ? _i8.UserMessage.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i9.UserMessage>) {
      return (data as List).map((e) => deserialize<_i9.UserMessage>(e)).toList()
          as T;
    }
    try {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i7.TypingIndicator) {
      return 'TypingIndicator';
    }
    if (data is _i8.UserMessage) {
      return 'UserMessage';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'TypingIndicator') {
      return deserialize<_i7.TypingIndicator>(data['data']);
    }
    if (dataClassName == 'UserMessage') {
      return deserialize<_i8.UserMessage>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i8.UserMessage:
        return _i8.UserMessage.t;
    }
    return null;
  }
  ...
  @override
  String getModuleName() => 'chat_app_serverpod';
}
